...
export default function AddProductPage() {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center flex-col p-4">
      <input type="text" placeholder="Product ID" className="input input-bordered w-full max-w-xs mb-2" value={productId} onChange={(e) => setProductId(e.target.value)} />
      ...
      <div className="w-full flex justify-center mt-4 items-center flex-row">
        ...
        <button className="bg-pink-500 text-white font-bold py-2 px-4 rounded" onClick={AddProduct}>Add Product</button>
      </div>
    </div>
  );
}